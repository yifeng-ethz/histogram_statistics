...
**DUT:** `histogram_statistics_v2` &nbsp; **Date:** `2026-05-01` &nbsp; **Scope:** `Phase-6 ping-pong readout gate`
...
PASS. Standalone regression completed with `46 PASS, 0 FAIL`.
...
| PASS | `B04_version` | `META[VERSION]=0x1a0181f5`, matching release `26.1.8.0501`. |
...
histogram queue loss. The new P05 case is the pre-gate for trusting live
1-second per-channel rate plots during active MuTRiG traffic.
